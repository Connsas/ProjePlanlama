            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href = "index.php" ><i class="fa fa-home"></i> Panel Anasayfası</a></li>
                  <li><a><i class="fa fa-cog"></i> Ayarlar <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="main_page.php">Başlangıç</a></li>
                      <li><a> Hakkımda <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                      ...
                      <ul class="nav child_menu">
                        <li><a href="education.php">Eğitim</a></li>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  ...
                  <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item"  href="logout.php"><i class="fa fa-sign-out pull-right"></i> Çıkış</a>
                  </div>
                </li>
